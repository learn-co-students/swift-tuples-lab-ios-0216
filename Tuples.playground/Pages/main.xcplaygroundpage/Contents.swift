 ...
 */
// write your code here
var someone = (name: "Danica", age: 29)
 ...
 */
// No, because the tuple is a 'let', so all of it's components are constants and are immutable. 
